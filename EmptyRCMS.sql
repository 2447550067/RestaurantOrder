...
insert  into `user`(`id`,`userCode`,`userName`,`userPassWord`,`phone`,`identity`,`createDate`) values (1,'admin','小明','admin','13333333333','111111111111111111','2018-05-07 00:00:00');
